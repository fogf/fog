...
class Celebrity(models.Model):
    ...
    en_name = models.CharField(max_length=64, verbose_name="英文名（可选）", default="")
    ...
    birth_area = models.CharField(max_length=128, verbose_name="出生地", default="")
    profession = models.CharField(max_length=16, verbose_name="职业", default="")
...
class Movie(models.Model):
    ...
    director = models.ManyToManyField(Celebrity, related_name="directors", verbose_name="导演")
    scriptwriter = models.ManyToManyField(Celebrity, related_name="scriptwriters", verbose_name="编剧")
